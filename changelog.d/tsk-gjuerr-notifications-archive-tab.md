...
- Dock pin redirect for `notification-archive` now carries a `section: "archive"` field that the dock launch path applies when the source pin is `notification-archive`.
