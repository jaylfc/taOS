...
Every taOS surface is LIVE: auto-refresh via the **S1 hook** (`tsk-vp7tt6`),
push updates via the **S2 hook** (`tsk-yh36f7`). Fetch-on-mount-once is a
defect. Full statement: `docs/design/live-surface-law.md`.
